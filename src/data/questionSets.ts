...
export const MATCHING: SubjectCard[] = [
  ...
  { subject: 'Mountain', group: 'Natural', note: 'nearest named peak', sizes: ALL, appKind: 'match-poi' },
  { subject: 'Landmass', group: 'Natural', note: 'same contiguous landmass / island', sizes: ALL },
  { subject: 'Park', group: 'Natural', note: 'nearest park', sizes: ALL, appKind: 'match-poi' },
  ...
  { subject: 'Golf Course', group: 'Places of Interest', note: 'nearest', sizes: ALL, appKind: 'match-poi' },
  { subject: 'Museum', group: 'Places of Interest', note: 'nearest', sizes: ALL, appKind: 'match-poi' },
  { subject: 'Movie Theater', group: 'Places of Interest', note: 'nearest', sizes: ALL, appKind: 'match-poi' },
  { subject: 'Sports Stadium', group: 'Places of Interest', note: 'nearest professional-sports stadium / arena', sizes: ALL },
  { subject: 'Hospital', group: 'Public Utilities', note: 'nearest', sizes: ALL, appKind: 'match-poi' },
  { subject: 'Library', group: 'Public Utilities', note: 'nearest', sizes: ALL, appKind: 'match-poi' },
...
export const MEASURING: SubjectCard[] = [
  ...
  { subject: 'A Mountain', group: 'Natural', note: 'nearest peak', sizes: ALL, appKind: 'measure-poi' },
  { subject: 'A Park', group: 'Natural', note: 'nearest park', sizes: ALL, appKind: 'measure-poi' },
  ...
  { subject: 'A Golf Course', group: 'Places of Interest', note: 'nearest', sizes: ALL, appKind: 'measure-poi' },
  { subject: 'A Museum', group: 'Places of Interest', note: 'nearest', sizes: ALL, appKind: 'measure-poi' },
  { subject: 'A Movie Theater', group: 'Places of Interest', note: 'nearest', sizes: ALL, appKind: 'measure-poi' },
  { subject: 'A Sports Stadium', group: 'Places of Interest', note: 'nearest professional-sports stadium / arena', sizes: ALL },
  { subject: 'A Hospital', group: 'Public Utilities', note: 'nearest', sizes: ALL, appKind: 'measure-poi' },
  { subject: 'A Library', group: 'Public Utilities', note: 'nearest', sizes: ALL, appKind: 'measure-poi' },
